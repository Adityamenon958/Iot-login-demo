...
export default function MaintenanceUpdatesContent({ selectedMonth, selectedYear }) {
  ...
  // ✅ Load default data (current month) and watch for prop changes
  useEffect(() => {
    // If no month selected, fetch current month data (like original)
    if (selectedMonth === '' && selectedYear === '') {
      fetchMaintenanceUpdates(); // This will fetch current month
    } else {
      fetchMaintenanceUpdates(selectedMonth, selectedYear);
    }
          ...
          {data.craneData.map((crane, index) => (
            <div key={crane.craneId} className="mb-3">
              ...
              <div className="d-flex justify-content-between align-items-center mb-2">
                ...
                <div className="mb-2 p-2" style={{ backgroundColor: '#fff3cd', borderRadius: '4px', border: '1px solid #ffeaa7' }}>
                  <div className="d-flex justify-content-between mb-1">
                    ...
                    <span className="fw-bold" style={{ fontSize: '0.6rem', color: '#856404' }}>
                      {formatHoursToHoursMinutes(crane.totalHours || crane.maintenanceHours)}
                    </span>
                  </div>
                  <div className="d-flex justify-content-between">
                ...
                {crane.maintenanceSessions && crane.maintenanceSessions.length > 0 && (
